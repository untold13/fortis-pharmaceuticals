...
assert.deepEqual(filterDefinitions.map(f=>[f.key,filterOptions[f.key].length]), [['system',9],['specialty',42],['use',44]]);
...
console.log('PASS: 95 document options; original form/dose choices; legacy matching; OR within groups and AND across groups; unassigned options remain visible.');
